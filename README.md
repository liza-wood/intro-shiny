...
This repository is a template for workshop readers, modified from the UC Davis DataLab.
This template uses **bookdown** to knit the reader. 
...
1. `index.Rmd`: Replace the all-caps text with your page details

2. `README.md`: Replace the all-caps text with your workshop details.

3. GitHub: In the repo's About section, add the reader URL and appropriate
   tags.

4. GitHub: In the repo's Settings page, enable GitHub pages. Set the branch to
...
* [Reader](https://liza-wood.github.io/YOUR_REPOSITORY/)
