...
Note that there are loads of example, all of which share source code (!), available through `[flexdashboard` examples](https://rstudio.github.io/flexdashboard/articles/examples.html).  
